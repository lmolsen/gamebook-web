        ...
        return (
            <div className="hints">
             ...
             {location.pathname === "/page6" && (<p className="hints__text"> {!isTouchDevice ? "Search slowly and the light will reveal the key." : "Tap wildly until you find the key!"}</p>)}
              ...
              {location.pathname === "/page26" && <p className="hints__text">I've heard feats of strength require a 5 or a 6 to accomplish.</p>}
              {location.pathname === "/page27" && <p className="hints__text">I bet there's more puzzles to the left.</p>}
              {location.pathname === "/wall-of-fame" && <p className="hints__text">Every good ending has a different accomplishment.</p>}
              {location.pathname === "/credits" && <p className="hints__text">Check out my GitHub for the code and full attributions!</p>}
            </div>
          );
        }